...
class Tankb(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        self.baseimage = pygame.transform.smoothscale(pygame.image.load("cpt/tankSprite/Blue Base 170x130.png").convert_alpha(), (170/5, 130/5))
...
class Tankr(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        self.baseimage = pygame.transform.smoothscale(pygame.image.load("cpt/tankSprite/Red Base 170x130.png").convert_alpha(), (170/5, 130/5))
        self.image = self.baseimage
        self.pos = (50,50)
        self.rect = self.image.get_rect(center=self.pos)
        self.angle = 180
...
class explode(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        self.images = []
        for i in range(16):
            self.images.append(pygame.transform.smoothscale(pygame.image.load("cpt/tankSprite/"+str(i)+".png").convert_alpha(), (100, 100)))
...
class Bullet(pygame.sprite.Sprite):
    def __init__(self, x, y, r, angle, counter, tank):
        ...
        self.angle = angle
        self.colourIndex = 0
        self.image = pygame.transform.smoothscale(pygame.image.load("cpt/tankSprite/redbullet.png").convert_alpha(), (10, 10))
    ...
    def changeColour(self):
        ...
        if self.colourIndex == 5:
            self.colourIndex = 0
        self.image = pygame.transform.smoothscale(pygame.image.load("cpt/tankSprite/" + bulletColours[self.colourIndex] + ".png").convert_alpha(), (10, 10))
